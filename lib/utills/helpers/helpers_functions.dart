...
class THelperFunctions {
  static Color? getColor(String value) {
    /// Define your specific colors here and it will match the artribute colors and shoe specific
  ...
  static String getFormateDate(DateTime date, {String formate = 'yMMMd'}) {
